...
(this, function () {
     ...
     * @param {number} [options.interval] delay between two elements in queue (in millis)
     * @constructor
     *
     * @example
     *
    ...
    Queue.prototype._dequeue = function () {
        ...
        try {
            ...
            new LocalPromise(function(resolve) {
                ...
                if (self.options.interval && self.lastItem) {
                    setTimeout(function() {
                        resolve();
                ...
                return resolveWith(item.promiseGenerator())
            })
            // Forward all stuff
                .then(function (value) {
